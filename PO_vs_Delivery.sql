SELECT 	COUNT(DISTINCT mstr_del.DELIVERY_ID) Delivery,
            
                SUM(om_line.UNIT_SELLING_PRICE * TO_BINARY_FLOAT (om_line.ORDERED_QUANTITY)) AMOUNT_DELIVERY,
                count(DISTINCT om_header.CUST_PO_NUMBER) Purchase, SUM(om_line.UNIT_SELLING_PRICE * TO_BINARY_FLOAT (REQUESTED_QUANTITY)) AMOUNT_PO
