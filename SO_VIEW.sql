SELECT om_line.line_ID,AR_.CREATION_DATE,om_line.LINE_NUMBER,
             ...
             AND (to_char(om_line.ACTUAL_SHIPMENT_DATE,'mm-YYYY')='05-2018'  or to_char(AR_.CREATION_DATE,'mm-YYYY')='05-2018'  OR om_line.FLOW_STATUS_CODE IN('PRE-BILLING_ACCEPTANCE','POST-BILLING_ACCEPTANCE')
